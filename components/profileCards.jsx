                ...
                <div className="py-16">
                    <div className="mx-auto px-6 max-w-6xl text-gray-500">
                        <div className="text-center">
                            ...
                            <p className="mt-6 text-gray-700 dark:text-gray-300">Here is some useful information from your business</p>
                        </div>
